package com.SecurityBoardEx.BoardEx.jwt.service;
...
class JwtServiceTest {
    ...
    public void init(){
        ...
        UserEntity member = UserEntity.builder().username(username).password("1234567890").nickname("Member1").build();
    ...
    public void destroyRefreshToken_refreshToken_제거() throws Exception {
        ...
        UserEntity member = userRepository.findByUsername(username).get();
